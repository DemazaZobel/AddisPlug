...
import maintenanceImg from "../assets/maintain.png"; // Replace with your EV maintenance image
...
export default function MaintenanceSection() {
  ...
  <span className="absolute left-0 -bottom-1 h-1 w-0 bg-gradient-to-r from-secondary to-accent rounded-full transition-all duration-500 group-hover:w-full"></span>
      ...
      {/* Maintenance Section - Dominant Image Edition */}
      <motion.div
      ...
      >
        ...
        >
          <img
            src={maintenanceImg}
            alt="EV Maintenance"
            className="w-full rounded-2xl shadow-xl object-cover h-80 md:h-96 lg:h-[28rem] transform transition-all duration-500 hover:scale-[1.015] blur-sm"
          />
          {/* Coming Soon Overlay */}
        ...
        <div className="w-full lg:w-[40%] text-center lg:text-left relative z-10 space-y-5 lg:space-y-6">
          ...
          >
            Keep Your EV in <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-teal-400">Top Shape</span>
          </motion.h4>
          ...
          >
            ...
            Trust our professional team to take care of <span className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-teal-400">battery health, performance checks, and overall EV care</span>.
          </motion.p>
